...
class ChatPage extends HookConsumerWidget {
  ...
  const ChatPage({super.key, required this.user, required this.currentUid});
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                // final data = list[list.length - 1 - index];
                return  ChatBubble(
                  clipper: ChatBubbleClipper8(
                    type: (currentUid != user.uid)
                        ? BubbleType.sendBubble
                        : BubbleType.receiverBubble,
                  ),
                  backGroundColor: (currentUid != user.uid)
                      ? ColorThemes.primary : ColorThemes.gray,
                  margin: const EdgeInsets.fromLTRB(5, 10, 5, 10),
                  padding: const EdgeInsets.fromLTRB(10, 5, 10, 5),
                  alignment: (currentUid != user.uid)
